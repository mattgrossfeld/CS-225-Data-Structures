...
class BinaryTree
{
  ...
  public:
    ...
    bool recursiveHelper(Node * subRoot) const;
    /**
    ...
    void pathsHelper(Node * subRoot, vector<vector<T> > &paths, vector<T> tempVector) const;
	...
	int sumDistancesHelper( Node * subRoot, int sum, int distance) const;
