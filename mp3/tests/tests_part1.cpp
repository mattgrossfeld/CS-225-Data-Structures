...
TEST_CASE("List::testing", "[weight=1][part=1]") {
  List<unsigned> list;
cout << "insertFront first" << endl;
...
list.reverse();
cout << list << endl;
cout << "Reverting to original order" << endl;
list.reverse();
cout << "ReverseNth, n = 5" << endl;
list.reverseNth(5);
cout << list << endl;
cout << "ReverseNth, n = 6" << endl;
list.reverseNth(6);
cout << list << endl;
cout << "waterfall!" << endl;
list.waterfall();
